...
def process_reports(args):
    ...
    typing_path = f"{args.output_directory}/typing_report.html"
    ...
    qc_path = f"{args.output_directory}/qc_report.html"
    ...
    st_path = f"{args.output_directory}/sttracker_report.html"
